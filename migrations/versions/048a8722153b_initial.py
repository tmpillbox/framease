...
Revision ID: 048a8722153b
Revises: 
Create Date: 2024-07-05 12:44:33.640792
...
def upgrade():
    ...
    with op.batch_alter_table('suite_case', schema=None) as batch_op:
        batch_op.create_index(batch_op.f('ix_suite_case_case_id'), ['case_id'], unique=False)
        batch_op.create_index(batch_op.f('ix_suite_case_sequence'), ['sequence'], unique=False)
        batch_op.create_index(batch_op.f('ix_suite_case_suite_id'), ['suite_id'], unique=False)
...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    with op.batch_alter_table('suite_case', schema=None) as batch_op:
        batch_op.drop_index(batch_op.f('ix_suite_case_suite_id'))
        batch_op.drop_index(batch_op.f('ix_suite_case_sequence'))
        batch_op.drop_index(batch_op.f('ix_suite_case_case_id'))
